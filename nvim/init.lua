...
vim.keymap.set('n', '<space>c', vim.diagnostic.setloclist, { desc = 'Open diagnostics list' })


-- Load custom configs
require 'custom.configs.auto-format'
...
-- Enable telescope flutter native, if installed
